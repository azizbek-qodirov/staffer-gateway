...
func (h *Handler) CreateGuide(ctx *gin.Context) {
	...
	res, err := h.GuideStorage.CreateGuide(ctx, req)
	if err != nil {
		panic(err)
	}
	ctx.JSON(200, res)
...
func (h *Handler) GetGuide(ctx *gin.Context) {
	...
	res, err := h.GuideStorage.GetGuide(ctx, req)
	if err != nil {
		panic(err)
	}
	ctx.JSON(200, res)
...
func (h *Handler) UpdateGuide(ctx *gin.Context) {
	...
	res, err := h.GuideStorage.UpdateGuide(ctx, req)
	if err != nil {
		panic(err)
	}
	ctx.JSON(200, res)
...
func (h *Handler) DeleteGuide(ctx *gin.Context) {
	...
	res, err := h.GuideStorage.DeleteGuide(ctx, req)
	if err != nil {
		panic(err)
	}
	ctx.JSON(200, res)
...
func (h *Handler) ListAllGuides(ctx *gin.Context) {
	...
	res, err := h.GuideStorage.ListAllGuides(ctx, req)
	if err != nil {
		panic(err)
	}
	ctx.JSON(200, res)
...
func (h *Handler) SearchGuides(ctx *gin.Context) {
	...
	res, err := h.GuideStorage.SearchGuides(ctx, req)
	if err != nil {
		panic(err)
	}
	ctx.JSON(200, res)
